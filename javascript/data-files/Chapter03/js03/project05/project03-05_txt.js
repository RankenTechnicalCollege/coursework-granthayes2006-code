...
for (let i = 0; i < phones.length; i++) { // Fixed index: start at 0, use < length
...
document.getElementsByTagName("tbody")[0].insertAdjacentHTML("beforeend", barChart); // Fixed: reference [0] element
